...
// 	fmt.Println(resp)
// 	// fmt.Println(resp.GetModelSpec())
// 	// fmt.Println(resp.GetOutputs())
// 	// out := resp.GetOutputs()
// 	// fmt.Println(out["output_1"].GetFloatVal())
// 	fmt.Println(pr.GetInputs()["input_1"])
...
import utils "client/tfserving_apis"
import "fmt"

func main(){
	var _ = [][]int64{{1}, {2}}
	x, _ := utils.MakeTensorProto([]float32{
		1., 2.,
		1., 3.,
	}, "DT_FLOAT", []int64{2, 2})
