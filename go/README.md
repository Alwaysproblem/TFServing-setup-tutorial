  ...
  - run go client for a simple example
    **don't forget source env.sh**
    - request data from server
      ...
      ```bash
      $ bash run.sh main/predict-service.go
      # model_spec:{name:"FC" version:{value:1} signature_name:"serving_default"} outputs:{key:"dense" value:{dtype:DT_FLOAT tensor_shape:{dim:{size:2} dim:{size:1}} float_val:0.21722326 float_val:0.72904724}}
      ```
