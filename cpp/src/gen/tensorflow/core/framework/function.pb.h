...
class FunctionDef_ArgAttrs PROTOBUF_FINAL :
...
class GradientDef PROTOBUF_FINAL :
...
inline void GradientDef::_internal_set_gradient_func(const std::string& value) {
  ...
  gradient_func_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline std::string* GradientDef::_internal_mutable_gradient_func() {
  ...
  return gradient_func_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* GradientDef::release_gradient_func() {
  ...
  return gradient_func_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
