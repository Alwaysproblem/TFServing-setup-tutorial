...
inline void TensorProto::clear_tensor_content() {
  tensor_content_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void TensorProto::_internal_set_tensor_content(const std::string& value) {
  ...
  tensor_content_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline std::string* TensorProto::_internal_mutable_tensor_content() {
  ...
  return tensor_content_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
