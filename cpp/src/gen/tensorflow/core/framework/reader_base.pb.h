...
class ReaderBaseState PROTOBUF_FINAL :
 ...
 public:
  ...
  void _internal_set_current_work(const std::string& value);
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_work_started() const;
  void _internal_set_work_started(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_work_finished() const;
  void _internal_set_work_finished(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_num_records_produced() const;
  void _internal_set_num_records_produced(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ReaderBaseState::_internal_work_started() const {
...
inline void ReaderBaseState::_internal_set_work_started(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ReaderBaseState::_internal_work_finished() const {
...
inline void ReaderBaseState::_internal_set_work_finished(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ReaderBaseState::_internal_num_records_produced() const {
...
inline void ReaderBaseState::_internal_set_num_records_produced(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void ReaderBaseState::set_current_work(const std::string& value) {
  _internal_set_current_work(value);
...
inline std::string* ReaderBaseState::mutable_current_work() {
  ...
  return _internal_mutable_current_work();
}
...
inline void ReaderBaseState::_internal_set_current_work(const std::string& value) {
  ...
  current_work_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline std::string* ReaderBaseState::_internal_mutable_current_work() {
  ...
  return current_work_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* ReaderBaseState::release_current_work() {
  ...
  return current_work_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
