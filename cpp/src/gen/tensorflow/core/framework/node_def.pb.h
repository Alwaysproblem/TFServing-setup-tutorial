...
class NodeDef_ExperimentalDebugInfo PROTOBUF_FINAL :
...
inline void NodeDef::unsafe_arena_set_allocated_experimental_debug_info(
    ::tensorflow::NodeDef_ExperimentalDebugInfo* experimental_debug_info) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(experimental_debug_info_);
  }
...
inline ::tensorflow::NodeDef_ExperimentalDebugInfo* NodeDef::_internal_mutable_experimental_debug_info() {
  ...
  if (experimental_debug_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::NodeDef_ExperimentalDebugInfo>(GetArena());
