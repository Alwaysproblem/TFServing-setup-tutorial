...
class AutoParallelOptions PROTOBUF_FINAL :
...
class ScopedAllocatorOptions PROTOBUF_FINAL :
...
class RewriterConfig_CustomGraphOptimizer PROTOBUF_FINAL :
...
class RewriterConfig PROTOBUF_FINAL :
...
inline void RewriterConfig::_internal_set_memory_optimizer_target_node_name_scope(const std::string& value) {
  ...
  memory_optimizer_target_node_name_scope_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline std::string* RewriterConfig::_internal_mutable_memory_optimizer_target_node_name_scope() {
  ...
  return memory_optimizer_target_node_name_scope_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RewriterConfig::release_memory_optimizer_target_node_name_scope() {
  ...
  return memory_optimizer_target_node_name_scope_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void RewriterConfig::unsafe_arena_set_allocated_memory_optimizer_target_node_name_scope(
  ...
  memory_optimizer_target_node_name_scope_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      memory_optimizer_target_node_name_scope, GetArena());
...
inline void RewriterConfig::unsafe_arena_set_allocated_auto_parallel(
    ::tensorflow::AutoParallelOptions* auto_parallel) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(auto_parallel_);
  }
...
inline ::tensorflow::AutoParallelOptions* RewriterConfig::_internal_mutable_auto_parallel() {
  ...
  if (auto_parallel_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::AutoParallelOptions>(GetArena());
    auto_parallel_ = p;
  }
...
inline void RewriterConfig::unsafe_arena_set_allocated_scoped_allocator_opts(
    ::tensorflow::ScopedAllocatorOptions* scoped_allocator_opts) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(scoped_allocator_opts_);
  }
...
inline ::tensorflow::VerifierConfig* RewriterConfig::_internal_mutable_inter_optimizer_verifier_config() {
  ...
  if (inter_optimizer_verifier_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::VerifierConfig>(GetArena());
