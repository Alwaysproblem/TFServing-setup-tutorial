...
class GraphDebugInfo_FileLineCol PROTOBUF_FINAL :
...
class GraphDebugInfo_StackTrace PROTOBUF_FINAL :
...
class GraphDebugInfo PROTOBUF_FINAL :
...
inline void GraphDebugInfo_FileLineCol::_internal_set_func(const std::string& value) {
  ...
  func_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline std::string* GraphDebugInfo_FileLineCol::_internal_mutable_func() {
  ...
  return func_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline ::tensorflow::GraphDebugInfo_FileLineCol* GraphDebugInfo_StackTrace::add_file_line_cols() {
  ...
  return _internal_add_file_line_cols();
}
