...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fexample_2fexample_2eproto = {
  false, false, descriptor_table_protodef_tensorflow_2fcore_2fexample_2fexample_2eproto, "tensorflow/core/example/example.proto", 388,
...
static bool dynamic_init_dummy_tensorflow_2fcore_2fexample_2fexample_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_tensorflow_2fcore_2fexample_2fexample_2eproto)), true);
namespace tensorflow {
