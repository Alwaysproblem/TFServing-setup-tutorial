...
inline ::tensorflow::SummaryMetadata_PluginData* SummaryMetadata::_internal_mutable_plugin_data() {
  ...
  if (plugin_data_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::SummaryMetadata_PluginData>(GetArena());
    plugin_data_ = p;
  }
  return plugin_data_;
}
...
inline ::tensorflow::SummaryMetadata* Summary_Value::_internal_mutable_metadata() {
  ...
  if (metadata_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::SummaryMetadata>(GetArena());
    metadata_ = p;
  }
  return metadata_;
}
...
inline void Summary_Value::unsafe_arena_set_allocated_obsolete_old_style_histogram(std::string* obsolete_old_style_histogram) {
  ...
  if (obsolete_old_style_histogram) {
    set_has_obsolete_old_style_histogram();
    value_.obsolete_old_style_histogram_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), obsolete_old_style_histogram, GetArena());
  }
...
inline ::tensorflow::Summary_Audio* Summary_Value::_internal_mutable_audio() {
  if (!_internal_has_audio()) {
    clear_value();
    set_has_audio();
    value_.audio_ = CreateMaybeMessage< ::tensorflow::Summary_Audio >(GetArena());
  }
