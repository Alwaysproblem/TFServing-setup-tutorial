...
class InferenceTask : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.InferenceTask) */ {
 public:
  ...
  inline InferenceTask* New() const { return New(NULL); }

  InferenceTask* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  friend void  protobuf_AddDesc_tensorflow_5fserving_2fapis_2finference_2eproto();
  friend void protobuf_AssignDesc_tensorflow_5fserving_2fapis_2finference_2eproto();
  friend void protobuf_ShutdownFile_tensorflow_5fserving_2fapis_2finference_2eproto();

  void InitAsDefaultInstance();
  static InferenceTask* default_instance_;
};
// -------------------------------------------------------------------
...
class InferenceResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.InferenceResult) */ {
 public:
  ...
  inline InferenceResult* New() const { return New(NULL); }

  InferenceResult* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  inline void set_has_classification_result();
  inline void set_has_regression_result();
  ...
  void InitAsDefaultInstance();
  static InferenceResult* default_instance_;
};
// -------------------------------------------------------------------
...
class MultiInferenceRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.MultiInferenceRequest) */ {
 public:
  ...
  inline MultiInferenceRequest* New() const { return New(NULL); }

  MultiInferenceRequest* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static MultiInferenceRequest* default_instance_;
};
// -------------------------------------------------------------------
...
class MultiInferenceResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.MultiInferenceResponse) */ {
 public:
  ...
  inline MultiInferenceResponse* New() const { return New(NULL); }

  MultiInferenceResponse* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static MultiInferenceResponse* default_instance_;
};
// ===================================================================
