...
void protobuf_AssignDesc_tensorflow_5fserving_2fapis_2fpredict_2eproto() {
  ...
  static const int PredictResponse_offsets_[2] = {
  ...
  PredictResponse_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      PredictResponse::default_instance_,
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PredictResponse, _is_default_instance_));
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
        ...
        ::google::protobuf::internal::MapEntry<
            ...
            0>::CreateDefaultInstance(
                PredictRequest_InputsEntry_descriptor_));
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      PredictResponse_descriptor_, &PredictResponse::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_tensorflow_5fserving_2fapis_2fpredict_2eproto() {
  ...
  delete PredictResponse::default_instance_;
  delete PredictResponse_reflection_;
}

void protobuf_AddDesc_tensorflow_5fserving_2fapis_2fpredict_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_tensorflow_5fserving_2fapis_2fpredict_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    ".TensorProto:\0028\001B\003\370\001\001b\006proto3", 589);
  ...
  PredictResponse::default_instance_ = new PredictResponse();
  PredictRequest::default_instance_->InitAsDefaultInstance();
  PredictResponse::default_instance_->InitAsDefaultInstance();
...
const PredictRequest& PredictRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_tensorflow_5fserving_2fapis_2fpredict_2eproto();
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.serving.PredictRequest)
  ...
  // repeated string output_filter = 3;
  total_size += 1 * this->output_filter_size();
  for (int i = 0; i < this->output_filter_size(); i++) {
...
PredictResponse* PredictResponse::default_instance_ = NULL;
...
int PredictResponse::ByteSize() const {
