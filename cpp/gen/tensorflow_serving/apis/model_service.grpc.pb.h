 ...
 public:
  ...
  class Stub final : public StubInterface {
   ...
   private:
    ...
    const ::grpc::RpcMethod rpcmethod_GetModelStatus_;
    const ::grpc::RpcMethod rpcmethod_HandleReloadConfigRequest_;
  };
  ...
  class WithAsyncMethod_GetModelStatus : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status GetModelStatus(::grpc::ServerContext* context, const ::tensorflow::serving::GetModelStatusRequest* request, ::tensorflow::serving::GetModelStatusResponse* response) final override {
      abort();
  ...
  class WithAsyncMethod_HandleReloadConfigRequest : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status HandleReloadConfigRequest(::grpc::ServerContext* context, const ::tensorflow::serving::ReloadConfigRequest* request, ::tensorflow::serving::ReloadConfigResponse* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
   ...
   public:
    WithStreamedUnaryMethod_GetModelStatus() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::StreamedUnaryHandler< ::tensorflow::serving::GetModelStatusRequest, ::tensorflow::serving::GetModelStatusResponse>(std::bind(&WithStreamedUnaryMethod_GetModelStatus<BaseClass>::StreamedGetModelStatus, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_HandleReloadConfigRequest() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::StreamedUnaryHandler< ::tensorflow::serving::ReloadConfigRequest, ::tensorflow::serving::ReloadConfigResponse>(std::bind(&WithStreamedUnaryMethod_HandleReloadConfigRequest<BaseClass>::StreamedHandleReloadConfigRequest, this, std::placeholders::_1, std::placeholders::_2)));
    }
