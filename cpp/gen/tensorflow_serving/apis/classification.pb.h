...
class Class : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.Class) */ {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_tensorflow_5fserving_2fapis_2fclassification_2eproto();
  friend void protobuf_AssignDesc_tensorflow_5fserving_2fapis_2fclassification_2eproto();
  friend void protobuf_ShutdownFile_tensorflow_5fserving_2fapis_2fclassification_2eproto();
...
class Classifications : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.Classifications) */ {
 public:
  ...
  inline Classifications* New() const { return New(NULL); }

  Classifications* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static Classifications* default_instance_;
};
// -------------------------------------------------------------------
...
class ClassificationResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ClassificationResult) */ {
 public:
  ...
  inline ClassificationResult* New() const { return New(NULL); }

  ClassificationResult* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ClassificationResult* default_instance_;
};
// -------------------------------------------------------------------
...
class ClassificationRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ClassificationRequest) */ {
 public:
  ...
  inline ClassificationRequest* New() const { return New(NULL); }

  ClassificationRequest* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ClassificationRequest* default_instance_;
};
// -------------------------------------------------------------------
...
class ClassificationResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ClassificationResponse) */ {
 public:
  ...
  inline ClassificationResponse* New() const { return New(NULL); }

  ClassificationResponse* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ClassificationResponse* default_instance_;
};
// ===================================================================
...
inline void ClassificationResponse::clear_model_spec() {
  if (GetArenaNoVirtual() == NULL && model_spec_ != NULL) delete model_spec_;
  model_spec_ = NULL;
}
