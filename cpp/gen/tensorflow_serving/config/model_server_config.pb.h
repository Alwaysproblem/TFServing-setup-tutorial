...
class ModelConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ModelConfig) */ {
 public:
  ...
  inline ModelConfig* New() const { return New(NULL); }

  ModelConfig* New(::google::protobuf::Arena* arena) const;
  ...
  private:
  void _slow_mutable_model_version_policy();
  ::tensorflow::serving::FileSystemStoragePathSourceConfig_ServableVersionPolicy* _slow_release_model_version_policy();
  public:
 ...
 private:
  ...
  typedef ::google::protobuf::internal::MapEntryLite<
      ...
      0 >
      ModelConfig_VersionLabelsEntry;
  ...
  friend void  protobuf_AddDesc_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto();
  friend void protobuf_AssignDesc_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto();
  friend void protobuf_ShutdownFile_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto();
...
class ModelConfigList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ModelConfigList) */ {
 public:
  ...
  inline ModelConfigList* New() const { return New(NULL); }

  ModelConfigList* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ModelConfigList* default_instance_;
};
// -------------------------------------------------------------------
...
class ModelServerConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ModelServerConfig) */ {
 public:
  ...
  inline ModelServerConfig* New() const { return New(NULL); }

  ModelServerConfig* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  inline void set_has_model_config_list();
  inline void set_has_custom_model_config();
  ...
  void InitAsDefaultInstance();
  static ModelServerConfig* default_instance_;
};
// ===================================================================
...
inline void ModelConfig::clear_model_version_policy() {
