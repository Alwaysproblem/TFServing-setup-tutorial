...
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2fattr_5fvalue_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2fattr_5fvalue_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "value_go_proto\370\001\001b\006proto3", 1025);
...
::tensorflow::AttrValue_ListValue* AttrValue::release_list() {
  ...
  if (has_list()) {
    clear_has_value();
    if (GetArenaNoVirtual() != NULL) {
      ::tensorflow::AttrValue_ListValue* temp = new ::tensorflow::AttrValue_ListValue;
      temp->MergeFrom(*value_.list_);
      value_.list_ = NULL;
      return temp;
    } else {
...
::tensorflow::NameAttrList* AttrValue::release_func() {
  ...
  if (has_func()) {
    clear_has_value();
    if (GetArenaNoVirtual() != NULL) {
      ::tensorflow::NameAttrList* temp = new ::tensorflow::NameAttrList;
      temp->MergeFrom(*value_.func_);
      value_.func_ = NULL;
      return temp;
    } else {
