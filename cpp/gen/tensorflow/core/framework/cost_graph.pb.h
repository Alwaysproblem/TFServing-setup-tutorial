...
class CostGraphDef_AggregatedCost : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.CostGraphDef.AggregatedCost) */ {
 public:
  ...
  inline CostGraphDef_AggregatedCost* New() const { return New(NULL); }

  CostGraphDef_AggregatedCost* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CostGraphDef_AggregatedCost* default_instance_;
};
// -------------------------------------------------------------------
