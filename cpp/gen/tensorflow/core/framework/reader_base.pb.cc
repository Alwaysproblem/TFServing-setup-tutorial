...
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2freader_5fbase_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2freader_5fbase_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ework/reader_base_go_proto\370\001\001b\006proto3", 317);
...
void ReaderBaseState::SharedDtor() {
  ...
  current_work_.Destroy(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
...
const ReaderBaseState& ReaderBaseState::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_tensorflow_2fcore_2fframework_2freader_5fbase_2eproto();
