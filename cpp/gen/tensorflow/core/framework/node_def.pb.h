...
class NodeDef_ExperimentalDebugInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NodeDef.ExperimentalDebugInfo) */ {
 public:
  ...
  inline NodeDef_ExperimentalDebugInfo* New() const { return New(NULL); }

  NodeDef_ExperimentalDebugInfo* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fframework_2fnode_5fdef_2eproto();
  ...
  static NodeDef_ExperimentalDebugInfo* default_instance_;
};
// -------------------------------------------------------------------
...
class NodeDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NodeDef) */ {
 public:
  ...
  private:
  void _slow_mutable_experimental_debug_info();
  void _slow_set_allocated_experimental_debug_info(
      ::google::protobuf::Arena* message_arena, ::tensorflow::NodeDef_ExperimentalDebugInfo** experimental_debug_info);
  ::tensorflow::NodeDef_ExperimentalDebugInfo* _slow_release_experimental_debug_info();
  public:
