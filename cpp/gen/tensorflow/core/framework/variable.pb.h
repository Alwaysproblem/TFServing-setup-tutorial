...
enum VariableSynchronization {
  ...
  VariableSynchronization_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  VariableSynchronization_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool VariableSynchronization_IsValid(int value);
const VariableSynchronization VariableSynchronization_MIN = VARIABLE_SYNCHRONIZATION_AUTO;
const VariableSynchronization VariableSynchronization_MAX = VARIABLE_SYNCHRONIZATION_ON_READ;
const int VariableSynchronization_ARRAYSIZE = VariableSynchronization_MAX + 1;
...
inline const ::std::string& VariableSynchronization_Name(VariableSynchronization value) {
  return ::google::protobuf::internal::NameOfEnum(
    VariableSynchronization_descriptor(), value);
}
...
enum VariableAggregation {
  ...
  VariableAggregation_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  VariableAggregation_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool VariableAggregation_IsValid(int value);
const VariableAggregation VariableAggregation_MIN = VARIABLE_AGGREGATION_NONE;
const VariableAggregation VariableAggregation_MAX = VARIABLE_AGGREGATION_ONLY_FIRST_REPLICA;
const int VariableAggregation_ARRAYSIZE = VariableAggregation_MAX + 1;
...
inline const ::std::string& VariableAggregation_Name(VariableAggregation value) {
  return ::google::protobuf::internal::NameOfEnum(
    VariableAggregation_descriptor(), value);
}
...
template <> struct is_proto_enum< ::tensorflow::VariableSynchronization> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::tensorflow::VariableAggregation> : ::google::protobuf::internal::true_type {};
template <>
