...
const ::google::protobuf::Descriptor* KernelList_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  KernelList_reflection_ = NULL;
...
void protobuf_AssignDesc_tensorflow_2fcore_2fframework_2fkernel_5fdef_2eproto() {
  ...
  static const int KernelDef_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(KernelDef, priority_),
  };
  ...
  KernelList_descriptor_ = file->message_type(1);
  static const int KernelList_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(KernelList, kernel_),
  };
  KernelList_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      KernelList_descriptor_,
      KernelList::default_instance_,
      KernelList_offsets_,
      -1,
      -1,
      -1,
      sizeof(KernelList),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(KernelList, _internal_metadata_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(KernelList, _is_default_instance_));
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      KernelList_descriptor_, &KernelList::default_instance());
}
...
void protobuf_ShutdownFile_tensorflow_2fcore_2fframework_2fkernel_5fdef_2eproto() {
  ...
  delete KernelList::default_instance_;
  delete KernelList_reflection_;
}

void protobuf_AddDesc_tensorflow_2fcore_2fframework_2fkernel_5fdef_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2fkernel_5fdef_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "_proto\370\001\001b\006proto3", 537);
...
// optional int32 priority = 6;
void KernelDef::clear_priority() {
  priority_ = 0;
}
 ::google::protobuf::int32 KernelDef::priority() const {
  // @@protoc_insertion_point(field_get:tensorflow.KernelDef.priority)
  return priority_;
}
 void KernelDef::set_priority(::google::protobuf::int32 value) {
...
KernelList* KernelList::default_instance_ = NULL;

KernelList* KernelList::New(::google::protobuf::Arena* arena) const {
  return ::google::protobuf::Arena::CreateMessage<KernelList>(arena);
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(10)) goto parse_loop_kernel;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
...
void KernelList::SerializeWithCachedSizes(
  ...
  // repeated .tensorflow.KernelDef kernel = 1;
  for (unsigned int i = 0, n = this->kernel_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->kernel(i), output);
  }
...
void KernelList::InternalSwap(KernelList* other) {
  kernel_.UnsafeArenaSwap(&other->kernel_);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
::google::protobuf::Metadata KernelList::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = KernelList_descriptor_;
  metadata.reflection = KernelList_reflection_;
  return metadata;
}
...
// repeated .tensorflow.KernelDef kernel = 1;
int KernelList::kernel_size() const {
  return kernel_.size();
}
void KernelList::clear_kernel() {
  kernel_.Clear();
}
const ::tensorflow::KernelDef& KernelList::kernel(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.KernelList.kernel)
  return kernel_.Get(index);
}
::tensorflow::KernelDef* KernelList::mutable_kernel(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.KernelList.kernel)
  return kernel_.Mutable(index);
}
::tensorflow::KernelDef* KernelList::add_kernel() {
