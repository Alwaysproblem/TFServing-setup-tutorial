...
class ServerDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.ServerDef) */ {
 public:
  ...
  private:
  void _slow_mutable_cluster_device_filters();
  void _slow_set_allocated_cluster_device_filters(
      ::google::protobuf::Arena* message_arena, ::tensorflow::ClusterDeviceFilters** cluster_device_filters);
  ::tensorflow::ClusterDeviceFilters* _slow_release_cluster_device_filters();
  public:
...
inline void ServerDef::clear_cluster_device_filters() {
