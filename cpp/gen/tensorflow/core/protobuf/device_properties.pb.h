...
class DeviceProperties : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.DeviceProperties) */ {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto();
  ...
  static DeviceProperties* default_instance_;
};
// -------------------------------------------------------------------
...
class NamedDevice : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NamedDevice) */ {
 public:
  ...
  inline NamedDevice* New() const { return New(NULL); }

  NamedDevice* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static NamedDevice* default_instance_;
};
// ===================================================================
