...
void protobuf_AddDesc_tensorflow_2fcore_2fprotobuf_2fqueue_5frunner_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.QueueRunnerDef)
  ...
  // repeated .tensorflow.error.Code queue_closed_exception_types = 5;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _queue_closed_exception_types_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
